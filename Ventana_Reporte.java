...
public class Ventana_Reporte extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Ventana_Reporte.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Genereacion de reportes");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 45, 354, 108));

        jButton1.setText("Genenrar reporte");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Ventana_Reporte().setVisible(true));
    }
